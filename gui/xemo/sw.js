const CACHE = "xemo-static-v994";
const SHELL = ["/", "/xemo/css/app.css?v=32", "/xemo/js/app-runtime-947.js?v=1113", "/xemo/js/movement-library.js?v=2", "/xemo/js/perception.js?v=7", "/xemo/js/perception-worker.js?v=4", "/xemo/js/protocol.js?v=98", "/xemo/fonts/SF-Pixelate.ttf", "/xemo/manifest.webmanifest"];
